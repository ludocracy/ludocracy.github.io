    ...
    return (
      <div className="About">
        ...
        <div className="words">
          ...
          <p>My interests are in political philosophy, climate change, <a rel="noopener noreferrer" target="_blank" href="https://eu.lolesports.com/en/league/na-lcs">LCS</a>, <a rel="noopener noreferrer" target="_blank" href="https://medium.com/@peterkong/on-blockchain-and-creative-capital-a48d074b0359">blockchain</a>, <a rel="noopener noreferrer" target="_blank" href="https://www.ravelry.com/projects/sixTwelveEighteen">crochet</a>, <a rel="noopener noreferrer" target="_blank" href="https://www.rhythmbones.com/">rhythm bones</a>, and <a rel="noopener noreferrer" target="_blank" href="http://www.chezpoor.com/minesweeper/minesweeper.html">minesweeper</a> where my best time on expert is 58 seconds.
          </p>
        </div>
      </div>
    );
